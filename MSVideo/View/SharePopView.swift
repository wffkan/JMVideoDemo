...
class SharePopView: UIView {
    ...
    func initSubView() {
        ...
        let label = UILabel.init(frame: CGRect.init(origin: .zero, size: CGSize.init(width: UIScreen.width, height: 35)))
        ...
        let itemWidth = 68
        let topScrollView = UIScrollView.init(frame: CGRect.init(x: 0, y: 35, width: UIScreen.width, height: 90))
        ...
        let bottomScrollView = UIScrollView.init(frame: CGRect.init(x: 0, y: 135, width: UIScreen.width, height: 90))
        ...
        cancel.frame = CGRect.init(x: 0, y: 230, width: UIScreen.width, height: 50 + UIScreen.safeAreaBottomHeight)
        cancel.titleEdgeInsets = UIEdgeInsets(top: -UIScreen.safeAreaBottomHeight, left: 0, bottom: 0, right: 0)
